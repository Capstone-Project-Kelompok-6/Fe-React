...
const ModalEditMembership = ({ handleModalEditTrigger, handleActionDrowpdon, update }) => {
	...
	return (
		<div className="relative z-50">
			<div className="fixed inset-0 z-50 bg-gray-400 bg-opacity-80 transition-opacity"></div>
						...
						<form onSubmit={handleUpdate} className="rounded-xl bg-white shadow">
							...
							<div className="space-y-6 p-6">
								<div className="relative">
									<input type="email" id="email" name="email" className={inputNotError} placeholder=" " required defaultValue={email} />
