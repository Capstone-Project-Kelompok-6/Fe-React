...
const BookingAPI = {
    ...
    async searchOfflineBooking(keyword) {
        try {
            const response = await axiosInstance.get(`/books/offline?query=${keyword}`);
            return response;
        } catch (error) {
            const { message } = error.response.data;
            throw new Error(message);
    ...
    async searchOnlineBooking(keyword) {
        try {
            const response = await axiosInstance.get(`/books/online?query=${keyword}`);
            return response;
        } catch (error) {
            const { message } = error.response.data;
            throw new Error(message);
