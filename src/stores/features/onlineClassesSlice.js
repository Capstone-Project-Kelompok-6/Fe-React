...
export const fetchOnlineClasses = createAsyncThunk("fetch/classes/online", async () => {
    try {
        const response = await ClassesAPI.getOnlineClasses();
...
export const fetchOnlineClassesByPrice = createAsyncThunk("fetch/classes/online/byprice", async (price) => {
    try {
...
export const createOnlineVideoClasses = createAsyncThunk("create/classes/online/video", async (data) => {
    try {
...
export const editOnlineVideoClasses = createAsyncThunk("edit/classes/online/video", async (data) => {
    try {
